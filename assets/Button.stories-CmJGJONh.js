import{j as e}from"./jsx-runtime-B7h7IusI.js";import{O as R,H as z,A as B,P as S,S as P}from"./Arrow1RightIcon-9PSXgIGM.js";import"./globals-Bkm8t2p5.js";import"./iframe-DhwV8Ikh.js";import"./preload-helper-PPVm8Dsz.js";function I({children:T,size:v="medium",variant:O="filled",color:h="primary",loading:f,content:t,text:L,icon:y,...b}){const j=v!=="small"?"Body-02-SB":"Caption-01";return e.jsxs("button",{className:"Button","data-size":v,"data-variant":O,...h&&{"data-color":h},...f&&{"data-loading":f},...t==="iconOnly"&&{"data-icon-only":!0},...b,children:[t==="iconLeft"&&e.jsx("span",{className:"ButtonIcon",children:y}),t!=="iconOnly"&&e.jsx("span",{className:`${j}`,children:L}),t==="iconOnly"&&e.jsx("span",{className:"ButtonIcon",children:f?e.jsx(R,{className:"ButtonLoading"}):y}),t==="iconRight"&&e.jsx("span",{className:"ButtonIcon",children:y})]})}I.__docgenInfo={description:"",methods:[],displayName:"Button",props:{size:{required:!1,tsType:{name:"union",raw:'"large" | "medium" | "small"',elements:[{name:"literal",value:'"large"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"small"'}]},description:`버튼 크기
...
}`,...x.parameters?.docs?.source}}};const _=["PrimaryFilled","PrimaryOutlined","PrimaryGhost","MonoFilled","MonoOutlined","MonoGhost","Small","Medium","Large","IconLeft","IconRight","IconOnly","Disabled","Loading"];export{g as Disabled,d as IconLeft,p as IconOnly,u as IconRight,m as Large,x as Loading,c as Medium,o as MonoFilled,s as MonoGhost,i as MonoOutlined,r as PrimaryFilled,a as PrimaryGhost,n as PrimaryOutlined,l as Small,_ as __namedExportsOrder,G as default};
